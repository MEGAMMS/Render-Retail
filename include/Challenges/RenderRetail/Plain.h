...
private:
    ...
    Plain(glm::vec3 position, glm::vec2 size, glm::vec3 orientation);
public:
    Plain(glm::vec3 position, glm::vec2 size, glm::vec3 orientation, glm::vec3 color);
    Plain(glm::vec3 position, glm::vec2 size, glm::vec3 orientation, const std::string& textureName);
