...
void StoreWalls::setWallTexture(Wall wall, const std::string& texturePath, glm::vec2 textureScale) {
    walls[static_cast<int>(wall)]->setTexture(texturePath, textureScale);
}
