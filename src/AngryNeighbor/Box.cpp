...
Box::Box(glm::vec3 position, glm::vec3 size, glm::vec3 orientation,
...
Box::Box(glm::vec3 position, glm::vec3 size, glm::vec3 orientation,
         std::vector<int> facesToRender, glm::vec3 color)
    : Box(position, size, orientation, facesToRender) {
  this->color = color;
}
Box::Box(glm::vec3 position, glm::vec3 size, glm::vec3 orientation,
         std::vector<int> facesToRender, const std::string &textureName)
    : Box(position, size, orientation, facesToRender) {
  useTexture = 1;
...
void Box::render(glm::mat4 &mvp, glm::vec3 lightPos, glm::vec3 lightColor,
                 glm::vec3 viewPos) {
...
void Box::onKeyEvent(int32_t key, int32_t scancode, int32_t action,
                     int32_t mode) {}

// Function to generate vertices and indices based on selected faces
std::pair<std::vector<Box::Vertex>, std::vector<GLuint>>
Box::generateVerticesAndIndices(std::vector<int> &facesToRender) {
  // Original face data (6 faces, each with 4 vertices)
  std::vector<std::vector<Box::Vertex>> facesVertices = {
      {// Face 1
       {glm::vec3{0., 0., 0.}, glm::vec2{0., 0.}, {0.0, 0.0, 1.0}},
       {glm::vec3{1., 0., 0.}, glm::vec2{1., 0.}, {0.0, 0.0, 1.0}},
       {glm::vec3{0., 1., 0.}, glm::vec2{0., 1.}, {0.0, 0.0, 1.0}},
       {glm::vec3{1., 1., 0.}, glm::vec2{1., 1.}, {0.0, 0.0, 1.0}}},
      {// Face 2
       {glm::vec3{0., 0., 1.}, glm::vec2{0., 0.}, {0.0, 0.0, -1.0}},
       {glm::vec3{1., 0., 1.}, glm::vec2{1., 0.}, {0.0, 0.0, -1.0}},
       {glm::vec3{0., 1., 1.}, glm::vec2{0., 1.}, {0.0, 0.0, -1.0}},
       {glm::vec3{1., 1., 1.}, glm::vec2{1., 1.}, {0.0, 0.0, -1.0}}},
      {// Face 3
       {glm::vec3{0., 0., 0.}, glm::vec2{0., 0.}, {0.0, 1.0, .0}},
       {glm::vec3{1., 0., 0.}, glm::vec2{1., 0.}, {0.0, 1.0, .0}},
       {glm::vec3{0., 0., 1.}, glm::vec2{0., 1.}, {0.0, 1.0, .0}},
       {glm::vec3{1., 0., 1.}, glm::vec2{1., 1.}, {0.0, 1.0, .0}}},
      {// Face 4
       {glm::vec3{0., 1., 0.}, glm::vec2{0., 0.}, {0.0, -1.0, .0}},
       {glm::vec3{1., 1., 0.}, glm::vec2{1., 0.}, {0.0, -1.0, .0}},
       {glm::vec3{0., 1., 1.}, glm::vec2{0., 1.}, {0.0, -1.0, .0}},
       {glm::vec3{1., 1., 1.}, glm::vec2{1., 1.}, {0.0, -1.0, .0}}},
      {// Face 5
       {glm::vec3{1., 0., 0.}, glm::vec2{0., 0.}, {-1.0, 0.0, .0}},
       {glm::vec3{1., 0., 1.}, glm::vec2{1., 0.}, {-1.0, 0.0, .0}},
       {glm::vec3{1., 1., 0.}, glm::vec2{0., 1.}, {-1.0, 0.0, .0}},
       {glm::vec3{1., 1., 1.}, glm::vec2{1., 1.}, {-1.0, 0.0, .0}}},
      {// Face 6
       {glm::vec3{0., 0., 0.}, glm::vec2{0., 0.}, {1.0, 0.0, .0}},
       {glm::vec3{0., 0., 1.}, glm::vec2{1., 0.}, {1.0, 0.0, .0}},
       {glm::vec3{0., 1., 0.}, glm::vec2{0., 1.}, {1.0, 0.0, .0}},
       {glm::vec3{0., 1., 1.}, glm::vec2{1., 1.}, {1.0, 0.0, .0}}}};
